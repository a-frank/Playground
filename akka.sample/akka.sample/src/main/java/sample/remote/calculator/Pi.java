...
public class Pi {
	...
	public void calculate(final int nrOfWorkers, final int nrOfElements, final int nrOfMessages) {
		...
		// create the master
		ActorRef master = system.actorOf(Props.create(new MasterCreator(nrOfElements, nrOfMessages, nrOfWorkers, listener)), "master");
	...
	public static final class MasterCreator implements Creator<UntypedActor> {
		private final int nrOfElements;
		private final int nrOfMessages;
		private final int nrOfWorkers;
		private final ActorRef listener;
		private static final long serialVersionUID = -4433535071876047941L;

		private MasterCreator(int nrOfElements, int nrOfMessages, int nrOfWorkers, ActorRef listener) {
			this.nrOfElements = nrOfElements;
			this.nrOfMessages = nrOfMessages;
